...
#define BATCH           11
#define SPC		12   //added by menliang
#define MSRC		13
...
#define SSD_MIN_EVENT		300                //event->type  also in disksim_iosim.h
...
} ioreq_event;    //???????????????????????????????????????????????????????????/ add ioreq_event2 for debugging.
...
typedef struct disksim {
   ...
   double simtime;
//***************************************8*
   float ssd_write_count;
   float cache_write_count;
   float ssd_read_count;
   float cache_read_count;
   float cache_clean_count;
   int ssd_total_write_count;
   int cache_total_write_count;
   int ssd_total_read_count;
   int cache_total_read_count;
   int ssd_total_clean_count;
   int cache_total_clean_count;
   double ssd_current_idle_time;
//*************************************menliang
...
#define ssd_total_write_count (disksim->ssd_total_write_count)
#define cache_total_write_count (disksim->cache_total_write_count)
#define ssd_current_idle_time (disksim->ssd_current_idle_time)
#define ssd_total_read_count (disksim->ssd_total_read_count)
#define cache_total_read_count (disksim->cache_total_read_count)
#define ssd_write_count (disksim->ssd_write_count)
#define cache_write_count (disksim->cache_write_count)
#define ssd_read_count (disksim->ssd_read_count)
#define cache_read_count (disksim->cache_read_count)
#define cache_clean_count (disksim->cache_clean_count)
#define ssd_total_clean_count (disksim->ssd_total_clean_count)
#define cache_total_clean_count (disksim->cache_total_clean_count)
...
event *disksim_simulate_event (int);
